...
namespace NBitcoin.Tests
{
	...
	public class NodeBuilder : IDisposable
	{
		public static NodeBuilder Create([CallerMemberNameAttribute]string caller = null, string version = "0.13.1")
		{
			...
			var path = "E:\\Sources\\elements-docker\\elements-next\\src\\elementsd.exe";
			...
			if(retryDelete)
			{
				foreach(var bitcoind in Process.GetProcessesByName("elementsd"))
				{
	...
	public class CoreNode
	{
		...
		public async Task StartAsync()
		{
			...
			config.Add("whitebind", "127.0.0.1:" + ports[0]);
		...
		public uint256[] Generate(int blockCount, bool includeUnbroadcasted = true, bool broadcast = true)
		{
			var rpc = CreateRPCClient();
			return rpc.Generate(blockCount);
		}
		...
		public uint256[] FindBlock(int blockCount = 1, bool includeMempool = true)
		{
